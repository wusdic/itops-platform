import{l as D,as as m,n as p,m as s,p as v,q as t,aA as M,aB as B,j as u,k as n,s as H,av as L,v as f,x as E,y as I,z as O,A as N,C as S,F as T,az as V}from"./index-DeHMpJ-Y.js";function A(o){const{textColor2:r,cardColor:e,modalColor:l,popoverColor:d,dividerColor:a,borderRadius:b,fontSize:i,hoverColor:c}=o;return{textColor:r,color:e,colorHover:c,colorModal:l,colorHoverModal:m(l,c),colorPopover:d,colorHoverPopover:m(d,c),borderColor:a,borderColorModal:m(l,a),borderColorPopover:m(d,a),borderRadius:b,fontSize:i}}const K={common:D,self:A},q=p([s("list",`
