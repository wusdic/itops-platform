import{k as S,m as h,l as p,aQ as C,n as f,i as x,j as r,aX as k,aA as T,q as $,s as v,v as w,R,x as m,h as _,aY as j,ah as B}from"./index-DeEsbs8n.js";import{u as O}from"./Space-CucXZsRf.js";function N(e){const{opacityDisabled:a,heightTiny:t,heightSmall:i,heightMedium:l,heightLarge:s,heightHuge:c,primaryColor:o,fontSize:n}=e;return{fontSize:n,textColor:o,sizeTiny:t,sizeSmall:i,sizeMedium:l,sizeLarge:s,sizeHuge:c,color:o,opacitySpinning:a}}const P={common:S,self:N},V=h([h("@keyframes spin-rotate",`
 from {
 transform: rotate(0);
 }
 to {
