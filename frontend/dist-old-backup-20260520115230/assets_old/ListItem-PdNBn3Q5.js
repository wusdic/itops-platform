import{k as D,an as m,m as p,l as s,n as v,p as t,ao as M,ap as E,i as u,j as n,q as H,a6 as L,s as f,v as B,x as I,y as O,z as N,A as S,E as T,aa as V}from"./index-DeEsbs8n.js";function K(o){const{textColor2:r,cardColor:e,modalColor:l,popoverColor:d,dividerColor:a,borderRadius:b,fontSize:i,hoverColor:c}=o;return{textColor:r,color:e,colorHover:c,colorModal:l,colorHoverModal:m(l,c),colorPopover:d,colorHoverPopover:m(d,c),borderColor:a,borderColorModal:m(l,a),borderColorPopover:m(d,a),borderRadius:b,fontSize:i}}const q={common:D,self:K},A=p([s("list",`
